...
namespace TFSManager.Lib
{
    public class Core
    {
        public static List<string> GetTfsServerList()
        {
        ...
        public static List<TeamProjectCollection> GetTeamProjectCollections(Uri tfsServer)
        {
        ...
        public static TfsTeamProjectCollection GetTfsTeamProjectCollection(Guid collectionId, Uri tfsServer)
        {
            TfsConfigurationServer configurationServer =
                  TfsConfigurationServerFactory.GetConfigurationServer(tfsServer);
